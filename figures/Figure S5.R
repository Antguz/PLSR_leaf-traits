...
ref_LMA_predict <- fread("ref_LMA_predict_train.csv")
ref_WC_predict <- fread("ref_WC_predict_train.csv")
ref_EWT_predict <- fread("ref_EWT_predict_train.csv")
cwt_LMA_predict <- fread("cwt_LMA_predict_train.csv")
cwt_WC_predict <- fread("cwt_WC_predict_train.csv")
cwt_EWT_predict <- fread("cwt_EWT_predict_train.csv")
...
observed <- fread("traits_training.csv")
...
tiff("Figure_S5.tif", width = 15, height = 21, units = "cm", res = 600)
