...
#Traits
traits <- fread("traits_training.csv")
...
ref_LMA <- fread("ref_LMA_residuals_train.csv")
ref_WC <- fread("ref_WC_residuals_train.csv")
ref_EWT <- fread("ref_EWT_residuals_train.csv")

cwt_LMA <- fread("cwt_LMA_residuals_train.csv")
cwt_WC <- fread("cwt_WC_residuals_train.csv")
cwt_EWT <- fread("cwt_EWT_residuals_train.csv")
...
tiff("Figure_S7.tif", width = 21, height = 11.67, units = "cm", res = 600)
