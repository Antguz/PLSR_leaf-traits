...
data_life_form <- data_life_form[Model == "Training"]
...
data_all <- data_all[Model == "Training"]
...
A <- ggplot() +
  ...
  geom_errorbar(data = LMA_Rsq, aes(x = as.numeric(Spectra)+.1, y = Value, group = Life_form, colour = Life_form, ymin = Value-se, ymax = Value+se), width = .05) +    scale_colour_manual(values = c("Lianas" = pa[1], "Trees" = pa[2])) +
  scale_fill_manual(values = c("Lianas" = pa[1], "Trees" = pa[2])) +
  scale_y_continuous(limits = c(0.75, 0.97), expand=c(0,0), breaks = c(0.75, 0.8, 0.85, 0.9, 0.95), labels = c(0.75, "", 0.85, "", 0.95)) +
...
B <- ggplot() +
  ...
  geom_errorbar(data = WC_Rsq, aes(x = as.numeric(Spectra)+.1, y = Value, group = Life_form, colour = Life_form, ymin = Value-se, ymax = Value+se), width = .05) +    scale_colour_manual(values = c("Lianas" = pa[1], "Trees" = pa[2])) +
  scale_fill_manual(values = c("Lianas" = pa[1], "Trees" = pa[2])) +
  scale_y_continuous(limits = c(0.75, 0.97), expand=c(0,0), breaks = c(0.75, 0.8, 0.85, 0.9, 0.95), labels = c(0.75, "", 0.85, "", 0.95)) +
  th + xlab("") + ylab("") + theme( axis.text.x = element_blank()) 
  facet_grid(. ~ Trait, labeller = label_parsed)
...
C <- ggplot() +
  ...
  geom_errorbar(data = EWT_Rsq, aes(x = as.numeric(Spectra)+.1, y = Value, group = Life_form, colour = Life_form, ymin = Value-se, ymax = Value+se), width = .05) +    scale_colour_manual(values = c("Lianas" = pa[1], "Trees" = pa[2])) +
  scale_fill_manual(values = c("Lianas" = pa[1], "Trees" = pa[2])) +
  scale_y_continuous(limits = c(0.4, 0.97), expand=c(0,0), breaks = c(0.4, 0.5, 0.6, 0.7, 0.8, 0.9), labels = c("", 0.5, "", 0.7, "", 0.9)) +
  th + xlab("") + ylab("") + theme( axis.text.x = element_blank()) 
  facet_grid(. ~ Trait, labeller = label_parsed)
...
D <- ggplot() +
  ...
  scale_fill_manual(values = c("Lianas" = pa[1], "Trees" = pa[2])) +
  scale_y_continuous(limits = c(-0.05, 0.05), expand=c(0,0), breaks = c(-0.04, 0, 0.04), labels = c(-0.04, 0, 0.04)) +
  th + xlab("") + ylab("") + theme( axis.text.x = element_blank())
...
E <- ggplot() +
  ...
  scale_fill_manual(values = c("Lianas" = pa[1], "Trees" = pa[2])) +
  scale_y_continuous(limits = c(-0.015, 0.015), expand=c(0,0), breaks = c(-0.01, 0, 0.01), labels = c(-0.01, 0, 0.01)) +
  th + xlab("") + ylab("") + theme( axis.text.x = element_blank())
...
Fa <- ggplot() +
  ...
  scale_fill_manual(values = c("Lianas" = pa[1], "Trees" = pa[2])) +
  scale_y_continuous(limits = c(-0.06, 0.06), expand=c(0,0), breaks = c(-0.04, 0, 0.04), labels = c(-0.04, 0, 0.04)) +
  th + xlab("") + ylab("") + theme( axis.text.x = element_blank())
...
G <- ggplot() +
  ...
  scale_fill_manual(values = c("Lianas" = pa[1], "Trees" = pa[2])) +
  scale_y_continuous(limits = c(4, 21), expand=c(0,0)) +
  th + xlab("") + ylab("") + theme( axis.text.x = element_blank())
...
H <- ggplot() +
  ...
  scale_fill_manual(values = c("Lianas" = pa[1], "Trees" = pa[2])) +
  scale_y_continuous(limits = c(2.3, 5), expand=c(0,0), breaks = c(2.5, 3, 3.5, 4, 4.5, 5), labels = c(2.5, "", 3.5, "", 4.5, "")) +
  th + xlab("") + ylab("") + theme( axis.text.x = element_blank())
...
I <- ggplot() +
  ...
  scale_fill_manual(values = c("Lianas" = pa[1], "Trees" = pa[2])) +
  scale_y_continuous(limits = c(11, 30), expand=c(0,0)) +
  th + xlab("") + ylab("") + theme( axis.text.x = element_blank())
...
J <- ggplot() +
  ...
  scale_fill_manual(values = c("Lianas" = pa[1], "Trees" = pa[2])) +
  scale_y_continuous(limits = c(4, 13), expand=c(0,0), breaks = c(5, 7.5, 10, 12.5), labels = c(5, 7.5, 10, 12.5)) +
  th + xlab("") + ylab("") 
...
K <- ggplot() +
  ...
  scale_fill_manual(values = c("Lianas" = pa[1], "Trees" = pa[2])) +
  scale_y_continuous(limits = c(5.5, 11.99), expand=c(0,0)) +
...
L <- ggplot() +
  ...
  scale_fill_manual(values = c("Lianas" = pa[1], "Trees" = pa[2])) +
  scale_y_continuous(limits = c(7, 13.4), expand=c(0,0)) +
  th + xlab("") + ylab("") 
  theme( axis.text.x = element_blank())


tiff("Figure_S7.tif", width = 21, height = 21, units = "cm", res = 600)
ggarrange(A, B, C,
          D, E, Fa,
          G, H, I,
          J, K, L,
