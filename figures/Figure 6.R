...
data_life_form <- data_life_form[Process == "Testing"]
...
data_all <- data_all[Process == "Testing"]
...
A <- ggplot() +
  ...
  scale_y_continuous(limits = c(0.45, 0.95), expand=c(0,0)) +
...
B <- ggplot() +
  ...
  scale_fill_manual(values = c("Lianas" = '#33B09F', "Trees" = '#B66A34')) +
  scale_y_continuous(limits = c(0.47, 0.85), expand=c(0,0)) +
  th + xlab("") + ylab("") + theme( axis.text.x = element_blank()) 
  facet_grid(. ~ Trait, labeller = label_parsed)
...
C <- ggplot() +
  ...
  scale_fill_manual(values = c("Lianas" = '#33B09F', "Trees" = '#B66A34')) +
  scale_y_continuous(limits = c(0.0, 0.80), expand=c(0,0)) +
  th + xlab("") + ylab("") + theme( axis.text.x = element_blank()) 
  facet_grid(. ~ Trait, labeller = label_parsed)
...
D <- ggplot() +
  ...
  scale_fill_manual(values = c("Lianas" = '#33B09F', "Trees" = '#B66A34')) +
  scale_y_continuous(limits = c(-0.10, 0.10), expand=c(0,0)) +
  th + xlab("") + ylab("") + theme( axis.text.x = element_blank())
...
E <- ggplot() +
  ...
  scale_fill_manual(values = c("Lianas" = '#33B09F', "Trees" = '#B66A34')) +
  scale_y_continuous(limits = c(-0.025, 0.025), expand=c(0,0)) +
  th + xlab("") + ylab("") + theme( axis.text.x = element_blank())
...
H <- ggplot() +
  ...
  scale_fill_manual(values = c("Lianas" = '#33B09F', "Trees" = '#B66A34')) +
  scale_y_continuous(limits = c(3.2, 6.5), expand=c(0,0)) +
  th + xlab("") + ylab("") + theme( axis.text.x = element_blank())
...
I <- ggplot() +
  ...
  scale_fill_manual(values = c("Lianas" = '#33B09F', "Trees" = '#B66A34')) +
  scale_y_continuous(limits = c(17, 80), expand=c(0,0)) +
  th + xlab("") + ylab("") + theme( axis.text.x = element_blank())
...
K <- ggplot() +
  ...
  scale_fill_manual(values = c("Lianas" = '#33B09F', "Trees" = '#B66A34')) +
  scale_y_continuous(limits = c(8.5, 20), expand=c(0,0)) +
  th + xlab("") + ylab("") + theme( axis.text.x = element_blank())
